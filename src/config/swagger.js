...
const options = {
  ...
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "API documentation for the Library Management System built with Express and Prisma",
    },
    servers: [
      {
    ...
    components: {
      ...
      securitySchemes: {
        bearerAuth: {
          // Can be any name, referenced in route security tags
          type: "http",
          scheme: "bearer",
          bearerFormat: "JWT",
      ...
      schemas: {
        ...
        Book: {
          ...
          properties: {
            ...
            reserved_copies: { type: "integer", minimum: 0 },
            author_ids: {
              type: "array",
              items: { type: "string", format: "uuid" },
            },
        ...
        Policy: {
          ...
          properties: {
            ...
            library_id: { type: "string", format: "uuid" },
            max_borrow_days: { type: "integer", minimum: 1 },
            fine_per_day: { type: "number", format: "float" },
            max_books_per_user: { type: "integer", minimum: 1 },
            reservation_expiry_days: { type: "integer", minimum: 1 },
            created_at: { type: "string", format: "date-time" },
            updated_at: { type: "string", format: "date-time" },
          },
        },
        BorrowTransaction: {
          type: "object",
          properties: {
            borrow_id: { type: "string", format: "uuid" },
            user_id: { type: "string", format: "uuid" },
            book_id: { type: "string", format: "uuid" },
        ...
        Fine: {
          type: "object",
          properties: {
            fine_id: { type: "string", format: "uuid" },
            borrow_id: { type: "string", format: "uuid" },
            user_id: { type: "string", format: "uuid" },
            book_id: { type: "string", format: "uuid" },
            library_id: { type: "string", format: "uuid" },
            ...
            fine_date: { type: "string", format: "date-time" },
            updated_at: { type: "string", format: "date-time" },
          },
        },
        DocumentUpload: {
        ...
        UserInput: {
          type: "object",
          required: ["user_id", "library_id", "name", "email", "role"],
          properties: {
            user_id: {
              type: "string",
              format: "uuid",
              description:
                "MUST be provided, typically from an external auth system",
            },
            library_id: { type: "string", format: "uuid" },
            name: { type: "string" },
            email: { type: "string", format: "email" },
        ...
        AuthorInput: {
          ...
          properties: {
            ...
            book_ids: {
              type: "array",
              items: { type: "string", format: "uuid" },
              description: "Optional: Initial list of book IDs",
            },
          },
        },
        BookInput: {
        ...
        PolicyInput: {
          ...
          properties: {
            library_id: { type: "string", format: "uuid" },
            max_borrow_days: { type: "integer", minimum: 1 },
            fine_per_day: { type: "number", format: "float", minimum: 0 },
            max_books_per_user: { type: "integer", minimum: 1 },
            reservation_expiry_days: { type: "integer", minimum: 1 },
          },
        },
        ...
        TicketInput: {
          type: "object",
          required: ["user_id", "type", "subject", "message"],
          properties: {
            user_id: { type: "string", format: "uuid" },
            type: { type: "string" },
            subject: { type: "string" },
        ...
        FineInput: {
          type: "object",
          required: ["borrow_id", "user_id", "book_id", "library_id", "amount"],
          properties: {
            borrow_id: { type: "string", format: "uuid" },
            user_id: { type: "string", format: "uuid" },
            book_id: { type: "string", format: "uuid" },
        ...
        DocumentUploadInput: {
          type: "object",
          required: ["user_id", "library_id", "file_url"],
          properties: {
            user_id: { type: "string", format: "uuid" },
            book_id: { type: "string", format: "uuid", nullable: true },
            library_id: { type: "string", format: "uuid" },
        ...
        UnauthorizedResponse: {
          description:
            "Unauthorized - Invalid or missing token, or token expired.",
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/ErrorResponse" },
              example: {
        ...
        ForbiddenResponse: {
          description:
            "Forbidden - User does not have the required role/permissions.",
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/ErrorResponse" },
              example: {
